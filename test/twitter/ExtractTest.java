...
public class ExtractTest {
    ...
    @Test
    public void testGetMentionedUsersNoMentionOneTweet() {
    ...
    @Test
    public void testGetMentionedUsersNoMentionMultipleTweets() {
    ...
    @Test
    public void testGetMentionedUsersOneMentionMultipleTweets() {
    ...
    @Test
    public void testGetMentionedUsersMultipleMentionOneTweet() {
    	Set<String> mentionedUsers = Extract.getMentionedUsers(Arrays.asList(tweet4));
        
        assertEquals("expected empty set", mentionedUsers.size(), 3);
    }
    
    @Test
    public void testGetMentionedUsersMultipleMentionMultipleTweets() {
    	Set<String> mentionedUsers = Extract.getMentionedUsers(Arrays.asList(tweet1, tweet2, tweet3, tweet4));
        
        assertEquals("expected empty set", mentionedUsers.size(), 4);
    }
